...
namespace EMR_local.Entities
{
    ...
    public class Doctor
    {
        ...
        /// <summary>
        /// Foreign key referencing the Qualification to which the Doctor belongs 
        /// </summary>
        public Guid? Qualifications { get; set; }

        /// <summary>
        /// Navigation property representing the associated Qualification
        /// </summary>
        [ForeignKey("Qualifications")]
        public Qualification? Qualifications_Qualification { get; set; }
        /// <summary>
        /// Foreign key referencing the Specialisation to which the Doctor belongs 
        /// </summary>
        public Guid? Specialisations { get; set; }

        /// <summary>
        /// Navigation property representing the associated Specialisation
        /// </summary>
        [ForeignKey("Specialisations")]
        public Specialisation? Specialisations_Specialisation { get; set; }
        /// <summary>
