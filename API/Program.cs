...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "EMR_local", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<EMR_localContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "EMR_local API v1");
